    ...
    renderModal() {
        ...
        if (showImageViewer && imageId) {
            return (React.createElement(Modal, { visible: true, transparent: true, animationType: Platform.OS === 'ios' ? 'none' : 'fade', onRequestClose: this.closeImageViewer },
                React.createElement(ImageViewer, { getSourceContext: this.getSourceContext, imageId: imageId, images: images, infoTitleStyles: infoTitleStyles, infoDescriptionStyles: infoDescriptionStyles, closeIcon: closeIcon, onChange: this.onChangePhoto, onClose: this.closeImageViewer, theme: this.componentTheme })));
        }
        return null;
    }
    render() {
